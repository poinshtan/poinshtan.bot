...
--------------------------------
 ...
 --------------------------------
	if (matches[1]:lower() == 'tophoto' and not Clang) or (matches[1]:lower() == 'تبدیل به عکس' and Clang) and is_mod(msg) and msg.reply_id then
...
--------------------------------
	if (matches[1]:lower() == 'tosticker' and not Clang) or (matches[1]:lower() == 'تبدیل به استیکر' and Clang) and is_mod(msg) and msg.reply_id then
...
--------------------------------
 ...
 local text = matches[2]
  ...
  local file = download_to_file(url,'poinshtanBot.mp3')
...
--------------------------------
  ...
  --------------------------------
	...
	if (matches[1]:lower() == 'sticker ' and not Clang) or (matches[1]:lower() == 'استیکر ' and Clang) and is_mod(msg) then
		...
		local url = "https://sandbox-uploads.imgix.net/u/1514510571-1f10ed62f448a997f769ac65654ddf94?cs=150"..w.."&h="..h.."&fit=crop&txt="..eq.."&txtsize="..txtsize.."&txtclr="..txtclr.."&txtalign=middle,center&txtfont=generator%20Condensed%20Medium&mono=ff6598cc"
...
if (matches[1]:lower() == 'sticker x' and not Clang) or (matches[1]:lower() == 'استیکر x' and Clang) and is_sudo(msg) then
	...
	if (matches[1]:lower() == 'photo' and not Clang) or (matches[1]:lower() == 'عکس' and Clang) and is_mod(msg) then
		...
		local url = "https://sandbox-uploads.imgix.net/u/1514510571-1f10ed62f448a997f769ac65654ddf94?cs=150"..w.."&h="..h.."&fit=crop&txt="..eq.."&txtsize="..txtsize.."&txtclr="..txtclr.."&txtalign=middle,center&txtfont=code%20Condensed%20Medium&mono=ff6598cc"
		local receiver = msg.to.id
